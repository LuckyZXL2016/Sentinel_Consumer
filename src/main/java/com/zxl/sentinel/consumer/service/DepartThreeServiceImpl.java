 ...
 */
@Service
public class DepartThreeServiceImpl implements DepartService {

    @Autowired
    RestTemplate restTemplate;

    @Override
    @SentinelResource(value = "getDepartThree", fallback = "getFallHandlerBack", blockHandler = "getBlockHandlerBack")
